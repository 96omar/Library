    ...
    <body>
        ...
        <section class="body" style="height: auto;">
            <div class="container2" style="margin-left: -15px;">
                <img alt="lib_background" src="image/lib5.jpg" class="image2" style="width: 1535px;">
                <div class="middle3">
                    <div class="text3">Student Registration</div>
                    <form name="registration" action="" method="post">
                        <div class="imgcontainer2">
                            <img src="image/add.png" alt="signup_logo" class="avatar2">
                        </div>
                        <div class="reg">
                            ...
                            <input class="input" type="text" name="roll" placeholder ="Enter your Roll No" required=""><br><br>
                            <div>
                                <div class="btn_reg">
                        ...
                        <div class="have_account">
                            <span class="psw" style="font-size: 16px;margin-top: 15px;">Already Have <a style="text-decoration: none; font-size: 14px; color: whitesmoke;" href="student_signin.php">Account</a></span>
                        </div>
                    </form>
        ...
        if (isset($_POST['submit'])) {
            ...
            $pass = $_POST['password'];
            $roll = $_POST['roll'];
            /* $insert = "INSERT INTO student VALUES ('','$firstName', '$lastName', '$userName', '$email', '" . sha1($pass) . "', '$roll')";
            ...
            while ($raws = mysqli_fetch_assoc($run_sql)) {
                if ($raws['username'] == $userName) {
                    $count = $count + 1;
                }
            }
            if ($count == 0) {
                $retval = mysqli_query($conn, "INSERT INTO student VALUES ('','$firstName', '$lastName', '$userName', '$email', '" . sha1($pass) . "', '$roll')");
                if (!$retval) {
                    ...
                    <script type="text/javascript">
                        ...
                        window.location = "student_signin.php"
                    </script>
                    <?php
                }
            } else {
