        ...
        <section style = "width: 1520px;overflow: scroll;">
            ...
            <div class = "container" style = "width: 1400px; margin-top: 5px">
                <table class = "table table-hover"  >
                    ...
                    <?php
                    $count2 = 0;
                    $sql = "SELECT * FROM `massage` WHERE sender = 'student' GROUP BY `username`";
                    ...
                    if ($count2 == 0) {
                        ...
                        <tbody>
                            <?php
                            echo '<tr><td style = "color:midnightblue;font-size:20px;font-weight:bold;">No Massage Found</td></tr>';
                            /**http://localhost/LibraryManagmentSystem/**/
                              ?>
                        </tbody>
                        <?php
                        } else {
