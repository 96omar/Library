...
<html>
    ...
    <body>
        ...
        <section style="">
            ...
            <div class="card">
                <div class="circle">
                    <img src="image/b1.png" alt="user" style="width:140px;height: 140px; padding: 20px;">
                </div>
        ...
        if (isset($_POST['btn_pass'])) {
            ...
            if ($passw == $repassw) {
                $ins_sql = "UPDATE `student` SET `password`='" . sha1($repassw) . "' WHERE username = '$id'";
                ...
                if (!$run_sql) {
                    ...
                    <script type="text/javascript">
                        ...
                        window.location = "student_forget_pass.php"
                    </script>
                    <?php
                } else {
